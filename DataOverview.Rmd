...
load("MovieLens100/MovieLens100visuals.Rdata")
print(informationDf)
print(summary_plot)
```
...
```{r, fig.width=10, fig.height=11, echo=FALSE}
load("Movielens1M/MovieLens1Mvisuals.Rdata")
print(informationDf)
print(summary_plot)
```
...
```{r, fig.width=10, fig.height=11, echo=FALSE}
load("Jester/Jestervisuals.Rdata")
print(informationDf)
print(summary_plot)
```
...
<!-- ```{r, fig.width=10, fig.height=11, echo=FALSE} -->
<!-- load("personality/personalityvisuals.Rdata") -->
<!-- print(informationDf) -->
<!-- print(summary_plot) -->
<!-- ``` -->
